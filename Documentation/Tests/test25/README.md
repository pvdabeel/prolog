...
```ansi
[93m>>> Emerging : overlay://test25/web-1.0:run?{[]}
[00m
[32mThese are the packages that would be merged, in order:

[00mCalculating dependencies... done!

 └─[90m[00m[100mstep  1[00m[90m[00m─┤ [00mverify[00m[00m  test25/os[90m (unsatisfied constraints, assumed running)[00m
             │ [00mverify[00m[00m  test25/os[90m (unsatisfied constraints, assumed installed)[00m
             │ [00mverify[00m[00m  test25/db[90m (unsatisfied constraints, assumed running)[00m
             │ [00mverify[00m[00m  test25/app[90m (unsatisfied constraints, assumed running)[00m
             │ [36mdownload[32m  overlay://test25/web-1.0[00m

 └─[90m[00m[100mstep  2[00m[90m[00m─┤ [36minstall[32m   overlay://test25/web-1.0[00m

 └─[90m[00m[100mstep  3[00m[90m[00m─┤ [32m[00m[42mrun[00m[32m[00m[01m[32m     overlay://test25/web-1.0[00m[00m
...
[90m  required by: overlay://test25/web-1.0
[00m
[91m[01m- Unsatisfied constraints for run dependency: [00m
[00m  test25/db
...
[90m---
[00m[01mSummary: [00moverlay://test25/web-1.0: unsatisfied_constraints dependency on test25/app

[01mAffected package: [00m[90moverlay://test25/web-1.0[00m
[01mDependency: [00m[90mtest25/app[00m
...
[90m  Review dependency metadata in overlay://test25/web-1.0; constraint set: [constraint(none,,[])].
[00m
[90m---
[00m[01mSummary: [00moverlay://test25/web-1.0: unsatisfied_constraints dependency on test25/db

[01mAffected package: [00m[90moverlay://test25/web-1.0[00m
[01mDependency: [00m[90mtest25/db[00m
[01mPhases: [00m[90m[run][00m
...
[00m
[90m---
[00m[01mSummary: [00moverlay://test25/web-1.0: unsatisfied_constraints dependency on test25/os

[01mAffected package: [00m[90moverlay://test25/web-1.0[00m
[01mDependency: [00m[90mtest25/os[00m
