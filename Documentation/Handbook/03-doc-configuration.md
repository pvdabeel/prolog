...
| `config:curl_allow_http/1` | `false` | Permit cleartext http distfile mirrors (ftp never allowed). |
| `config:file_integrity/1` | `prefer` | Knowledge sidecar policy: `prefer`, `require`, or `off`. |
