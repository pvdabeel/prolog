...
:- thread_local preference:local_use/1.
:- thread_local preference:accept_keywords/1.
...
%! preference:env_accept_keywords_list(?Use)
%
...
preference:init :-
  ...
  forall(member(Use,List_USE),assert(preference:local_use(Use))),
