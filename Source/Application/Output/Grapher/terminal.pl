...
terminal:emit_html(Type, Target, HtmlContent, TimingStats) :-
    ...
    navtheme:emit_nav_bar(Repo, Entry, Cat, Name, Type, Newer, Newest, Older, Oldest, Ver),
...
%
% Title shown in the macOS-style terminal bar.
...
%
% Emit the terminal body in the handbook window (traffic-light bar +
% blinking cursor).
