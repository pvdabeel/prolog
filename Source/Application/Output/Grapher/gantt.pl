...
gantt:emit_filters :-
    ...
    write('    <span class="nav-group-label">phase</span>'), nl,
    ...
    write('  </div>'), nl,
    write('  <div class="nav-group">'), nl,
    write('    <span class="nav-group-label">action</span>'), nl,
    ...
    write('  </div>'), nl,
    write('  <div class="nav-group">'), nl,
    write('    <span class="nav-group-label">deps</span>'), nl,
    ...
    write('  </div>'), nl,
    write('  <div class="nav-group">'), nl,
    write('    <button class="filter-btn" onclick="expandAll()">expand</button>'), nl,
    write('    <button class="filter-btn" onclick="collapseAll()">collapse</button>'), nl,
    write('  </div>'), nl,
    write('</div>'), nl.
