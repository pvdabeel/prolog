...
llmknowledge:handbook_alias(planning, '12-doc-planning.md').
llmknowledge:handbook_alias(output, '13-doc-output.md').
llmknowledge:handbook_alias(cli, '14-doc-cli.md').
llmknowledge:handbook_alias(building, '15-doc-building.md').
llmknowledge:handbook_alias(llm, '16-doc-llm.md').
llmknowledge:handbook_alias(context, '21-doc-context-terms.md').
