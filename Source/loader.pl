...
loader:group(domain_modules,
   [portage('Source/Domain/Gentoo/eapi.pl'),
    ...
    portage('Source/Domain/Gentoo/Rules/slotmeta.pl'),
    portage('Source/Domain/Gentoo/Rules/cnselect.pl'),
    portage('Source/Domain/Gentoo/Rules/acceptance.pl'),
    portage('Source/Domain/Gentoo/Rules/ranking.pl'),
