...
| `loader.pl` | Mode table (`loader:mode/3`) and `load_modules/1` |
...
Source/
  ...
  Application/                           (application layer)
    ...
    Llm/                                  LLM backends: Claude, ChatGPT, Gemini, Grok, Ollama, explain, semantic search
  ...
  Logic/                                 (reasoning framework)
    ...
    Context/Examples/                     Worked OO context example (person class)
